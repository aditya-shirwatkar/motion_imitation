...
URDF_NAME = "./mpc_controller/stoch3_description/urdf/stoch3.urdf"
START_POS = [0, 0, 0.45]


MPC_BODY_MASS = 23
MPC_BODY_INERTIA = np.array((0.05922, 0, 0, 0, 0.06835, 0, 0, 0, 0.56123))
# MPC_BODY_INERTIA = (0.00575867, 0, 0, 0, 0.02534052, 0, 0, 0, 0.03025755)#*1.0# * 0.1 #* 2
# MPC_BODY_INERTIA = np.array((0.00719597419370983, 0, 0, 0, 0.020801993143838852, 0, 0, 0, 0.026600576328289285))#*1.0# * 0.1 #* 2
